...
async function init() {
  if (!isLoggedIn()) {
    ...
    document.getElementById('authModalClose')?.addEventListener('click', redirectIfNotLoggedIn);
    document.getElementById('authModalOverlay')?.addEventListener('click', redirectIfNotLoggedIn);
