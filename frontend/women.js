...
function toggleWishlistPage(id, btn, product) {
...
function renderProducts() {
  ...
  paginated.forEach(p => {
    ...
    wishlistBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      toggleWishlistPage(p._id, wishlistBtn, p);
    });

    card.querySelectorAll('.shop-action-btn:not(.shop-wishlist-btn)').forEach(btn => {
