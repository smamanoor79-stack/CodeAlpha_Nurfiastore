...
function renderProducts() {
  ...
  paginated.forEach(p => {
    ...
    const wishlistBtn = card.querySelector('.shop-wishlist-btn');
    wishlistBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      toggleWishlistShop(p._id, wishlistBtn, p);
    });

    card.querySelector('.shop-compare-btn').addEventListener('click', (e) => {
      e.stopPropagation();
    });
    card.querySelector('.shop-view-btn').addEventListener('click', (e) => {
      e.stopPropagation();
    });
